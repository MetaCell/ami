...
function decodeRLE(imageFrame: any, pixelData: Uint8Array | Int8Array): any {
...
function decode8(imageFrame: any, pixelData: Uint8Array | Int8Array): any {
...
function decode8Planar(imageFrame: any, pixelData: Uint8Array | Int8Array): any {
  const frameData = pixelData;
  const frameSize = imageFrame.rows * imageFrame.columns;
  const outFrame = new ArrayBuffer(frameSize * imageFrame.samplesPerPixel);
  const header = new DataView(frameData.buffer, frameData.byteOffset);
...
function decode16(imageFrame: any, pixelData: Uint8Array | Int8Array): any {
  const frameData = pixelData;
  const frameSize = imageFrame.rows * imageFrame.columns;
