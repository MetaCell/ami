...
const trackballOrtho = (three: typeof THREE = window.THREE!) => {
  ...
  return class ControlsTrackballOrtho extends Constructor {
    ...
    noZoom: boolean;
    noPan: boolean;
    // never actually toggled (this control has no rotate interaction), kept for
    // parity with the keyboard/mouse handlers that guard on it below.
    noRotate: boolean;
    ...
    handleResize() {
      if (this.domElement === document) {
        ...
        const d = (this.domElement as HTMLElement).ownerDocument.documentElement;
