...
class Unpack extends ShadersBase {
  private _packedData: string;
  private _offset: string;
  private _unpackedData: string;
  ...
  api(
    ...
    packedData: string = this._packedData,
    offset: string = this._offset,
    unpackedData: string = this._unpackedData
  ): string {
    this._base = baseFragment;
    return this.compute(packedData, offset, unpackedData);
  }

  compute(packedData: string, offset: string, unpackedData: string): string {
