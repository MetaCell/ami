...
export default class ModelsFrame extends ModelsBase {
  private _sopInstanceUID: string | null;
  ...
  private _imagePosition: number[] | null;
  private _imageOrientation: number[] | null;
  private _rightHanded: boolean;
  private _sliceThickness: number;
  private _spacingBetweenSlices: number | null;
  private _pixelPaddingValue: number | null;
  private _pixelRepresentation: number;
  private _pixelType: number;
  private _pixelSpacing: number[] | null;
  private _pixelAspectRatio: number[] | null;
  ...
  private _rescaleSlope: number | null;
  private _rescaleIntercept: number | null;

  private _bitsAllocated: number;
  private _numberOfChannels: number;

  private _minMax: number[] | null;
  private _dist: any;
   ...
   * @return {*}
   */
  setPixelData(column: number, row: number, value: number) {
  ...
  set frameTime(frameTime: number | null) {
  ...
  set ultrasoundRegions(ultrasoundRegions: any[]) {
  ...
  set spacingBetweenSlices(spacingBetweenSlices: number | null) {
  ...
  set imagePosition(imagePosition: number[] | null) {
  ...
  set imageOrientation(imageOrientation: number[] | null) {
  ...
  set pixelSpacing(pixelSpacing: number[] | null) {
  ...
  set pixelAspectRatio(pixelAspectRatio: number[] | null) {
  ...
  set dimensionIndexValues(dimensionIndexValues: number[]) {
  ...
  set instanceNumber(instanceNumber: number | null) {
  ...
  set pixelData(pixelData: any) {
    this._pixelData = pixelData;
  }

  set sopInstanceUID(sopInstanceUID: string | null) {
  ...
  set pixelPaddingValue(pixelPaddingValue: number | null) {
  ...
  set referencedSegmentNumber(referencedSegmentNumber: number) {
